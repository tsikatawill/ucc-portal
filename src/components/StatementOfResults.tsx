      ...
      <section className="statement-of-results sm:flex">
        ...
        <aside className="p-5">
          ...
          <div className="statuses flex flex-col items-start mt-2 gap-3">
            <div className="inactive flex items-center gap-2">
              <div className="status-icon bg-red-500 p-2 rounded-md">
            ...
            <div className="with-lecturer flex items-center gap-2">
              <div className="status-icon bg-orange-500 p-2 rounded-md">
                <FaFlagCheckered color="white" />
              </div>
              <div className="desc">
            ...
            <div className="with-department flex items-center gap-2">
              <div className="status-icon bg-yellow-500 p-2 rounded-md">
            ...
            <div className="with-faculty flex items-center gap-2">
              <div className="status-icon bg-blue-500 p-2 rounded-md">
                <FaFlagCheckered color="white" />
              </div>
              <div className="desc">
